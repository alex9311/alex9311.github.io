...
All the code I wrote for this project can be found on my [GitHub](https://github.com/alex9311/alex9311.github.io/tree/master/code-projects).
...
I wrote a script which processes epub books into documents of tokens and a vocabulary.
...
Remember!
These topics were learned in an upservised way, the algorithm had no infromation about which pages came from which chapters.
...
AWS SageMaker made the process fairly painless once the text was properly processed and Gephi provided fun visualization.
